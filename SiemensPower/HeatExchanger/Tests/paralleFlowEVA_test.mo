within SiemensPower.HeatExchanger.Tests;
model paralleFlowEVA_test "Test case for Benson parallelFlowEvaporator"
  extends Modelica.Icons.Example;
  SiemensPower.HeatExchanger.ParallelFlowEvaporator EVA1(
  ...
  SiemensPower.HeatExchanger.ParallelFlowEvaporator EVA2(
    geoPipe(Nt=80),
  ...
  SiemensPower.Components.Pipes.TubeWithoutWall downcomer(
    geoPipe(
      Nt=2,
      L=26,
      H=-21,
