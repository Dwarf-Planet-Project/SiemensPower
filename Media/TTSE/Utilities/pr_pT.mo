...
function pr_pT "Pr(p,T)"
  ...
  external "C" pr= TTSE_pr_pT(phase, p, T);

  annotation(Library={"TTSEmoI", "TTSE"}, Documentation(info="<html>
<p>This function returns the Prandtl number as function of p and T. The water/steam functions are computed according to TTSE. </p>
</html>
<HTML> 
       <p>  
     <table>
