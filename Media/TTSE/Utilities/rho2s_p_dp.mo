...
function rho2s_p_dp "drho2s(p)/dp"
  import SI = Modelica.SIunits;
  input SI.Pressure p "Pressure";

  output Real drho2s_dp "Pressure Derivative of dew density";

  external "C" drho2s_dp=TTSE_d1_rho2s_p_dp(p);

  annotation(Library={"TTSEmoI", "TTSE"}, Documentation(info="<html>
<p>This function returns the partial derivative of dew density wrt p according to TTSE. </p>
</html>
<HTML> 
       <p>  
     <table>
