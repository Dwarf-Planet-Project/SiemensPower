...
function p_rhoh_drho "dp(rho,h)/drho"
  import SI = Modelica.SIunits;
    input SI.Density rho "Density";
    input SI.SpecificEnthalpy h "Specific Enthalpy";
    output Real dp_drho "Partial derivative dp/drho";

    external "C" dp_drho=TTSE_d1_p_rhoh_drho(
  rho,
    h);
    annotation (Library={"TTSEmoI", "TTSE"}, Documentation(info="<html>
<p>This function returns the partial derivative of p wrt rho versus rho and h according to TTSE. </p>
</html>
