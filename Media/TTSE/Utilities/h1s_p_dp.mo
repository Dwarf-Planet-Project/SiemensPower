...
function h1s_p_dp "dh1s(p)/dp"
  import SI = Modelica.SIunits;
  input SI.Pressure p "Pressure";

  output Real dh1s_dp "Pressure derivative of bulb enthalpy";

  external "C" dh1s_dp=TTSE_d1_h1s_p_dp(p);

  annotation(Library={"TTSEmoI", "TTSE"}, Documentation(info="<html>
<p>This function returns the partial derivative of bulb enthalpy wrt p according to TTSE. </p>
</html>
