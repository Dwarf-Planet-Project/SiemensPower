...
function der_T_rhoh "Time derivative of T(rho,h)"
...
algorithm
  der_T := SiemensPower.Media.TTSE.Utilities.T_rhoh_dh(rho, h)*der_h +
    SiemensPower.Media.TTSE.Utilities.T_rhoh_drho(rho, h)*der_rho;

annotation (
    Documentation(
 info="<html>
<p>This function returns the time derivative of the temperature as function of rho and h according to the chain rule. The partial derivatives are build with help of TTSE functions. </p>
</html>
